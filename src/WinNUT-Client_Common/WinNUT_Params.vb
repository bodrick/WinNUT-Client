...
Public Module WinNUT_Params
    ...
    Private ReadOnly Arr_Reg_Key_Base As New Dictionary(Of String, Dictionary(Of String, Object))
    Private ReadOnly Cryptor As New CryptData()
    Private RegPath As String

    Public Function ImportIni(FileName As String) As Boolean
        Dim Result = False
        Try
